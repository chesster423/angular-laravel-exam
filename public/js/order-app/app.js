...
angular.module('trial-app', ['OrderModule', 'AuthModule']).service("APIService", ["$http", "$q", "$storage", "TokenService", function ($http, $q, $storage, TokenService) {
  return {
    MakeRequest: function MakeRequest(url, method) {
  ...
  return {
    ...
    GetOrderDetails: function GetOrderDetails(order_id) {
